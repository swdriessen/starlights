...
////public class PersistenceUpdated : IPersistence
////{
////    private readonly ILogger<PersistenceUpdated> _logger;
////    private readonly IContextFactoryRegistry _contextFactoryRegistry;
////    private readonly IServiceProvider _serviceProvider;
////    private readonly Dictionary<Type, IPersistenceContext> _contexts = new();
////    private bool _disposedValue;

////    public PersistenceUpdated(ILogger<PersistenceUpdated> logger, IContextFactoryRegistry contextFactoryRegistry, IServiceProvider serviceProvider)
////    {
////        _logger = logger;
...
////            _logger.LogInformation("created new context [type='{ContextType}']", contextType.Name);
////        }
