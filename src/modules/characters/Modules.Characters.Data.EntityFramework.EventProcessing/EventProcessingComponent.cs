...
internal class EventProcessingComponent : IPlatformServiceComponent
{
    ...
    public void ConfigureServices(IHostApplicationBuilder builder) => builder.Services.AddHostedService<DomainEventProcessingService>();
}
...
public static class EventProcessingComponentExtensions
{
    ...
    /// </summary>
    public static void AddEventProcessingComponent(this PlatformBuilderOptions options) => options.AdditionalAssemblies.Add(typeof(EventProcessingComponent).Assembly);
}
